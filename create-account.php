...
<head>
    ...
    <title>Create Account - MediBook Ghana</title>
    <style>
        body {
...
?>
    ...
    <div class="container">
        <table border="0" style="width: 69%;">
            <tr>
                <td colspan="2">
                    <p class="header-text">Complete Your Registration</p>
                    <p class="sub-text">Set up your login credentials to access MediBook Ghana</p>
                </td>
            </tr>
            <tr>
